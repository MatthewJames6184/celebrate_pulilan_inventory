            ...
            <section className="text-scale relative overflow-hidden px-4 py-14 sm:px-6 lg:px-8" style={{ fontSize: '16px' }}>
                ...
                <div className="mx-auto max-w-6xl rounded-[2rem] border border-white/60 bg-white/92 p-6 shadow-2xl shadow-emerald-950/20 backdrop-blur-sm md:p-10">
                    <header className="text-center">
                        ...
                        <h1 className="mt-4 text-3xl leading-tight font-semibold text-slate-950 md:text-5xl">Guides, forms, and useful files.</h1>
                    ...
                    <div className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
                        <section>
                            ...
                            <div className="mt-6 grid gap-4">
                                {downloadItems.map((item) => (
                                    ...
                                    >
                                        <p className="text-xs font-semibold tracking-[0.2em] text-emerald-700 uppercase">{item.category}</p>
                                        ...
                                        <button
                                            type="button"
                                            className="mt-4 inline-flex items-center gap-2 rounded-full bg-emerald-700 px-4 py-2 text-xs font-semibold tracking-[0.15em] text-white uppercase transition hover:bg-emerald-800"
                                        >
                        ...
                        <aside className="space-y-4 rounded-3xl bg-emerald-50/70 p-6 lg:border lg:border-emerald-200 lg:bg-emerald-50/50">
                            ...
                            <Link
                                href={route('contact')}
                                className="inline-flex items-center gap-2 rounded-full bg-amber-400 px-4 py-2 text-xs font-semibold tracking-[0.15em] text-emerald-950 uppercase transition hover:bg-amber-300"
                            >
